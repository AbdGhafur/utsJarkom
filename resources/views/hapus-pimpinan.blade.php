    ...
    <body>
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <form action="{{ route('pimpinan.search') }}" class="d-flex me-3" role="search">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <br>
                                <h5 class="card-title">Daftar Barang yang akan dihapus</h5>
                                <br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="text-align: center; text-decoration:none;">
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                <a class="btn btn-outline-danger btn-sm" href="{{ route('barang.destroy', $item->idbarang) }}" onclick="event.preventDefault(); document.getElementById('hapus-barang-{{ $item->idbarang }}').submit();">Hapus</a>
                                                <form id="hapus-barang-{{ $item->idbarang }}" action="{{ route('barang.destroy', $item->idbarang) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
