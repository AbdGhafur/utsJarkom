    ...
    <body>
        ...
        <div class="container">
            <div class="d-flex justify-content-between">
                <div class="container-fluid">
                    <a href="{{url('/add_table_data')}}" type="button" class="btn btn-outline-primary shadow-sm fw">
                        <i class="bi bi-plus-lg"></i>
                        Baru
                    </a>
                </div>
                <div class="container-fluid">
                    <form action="{{ route('barang.search') }}" method="GET" class="d-flex sh ">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align: center;">
                                    ...
                                    <td class="gap-3">
                                        <a href="{{url('/generateQRCode/'.$bar->idbarang)}}" class="btn btn-outline-info shadow-sm"><i class="bi bi-eye"></i> Lihat</a>
                                        <a href="{{url('/edit/'.$bar->idbarang)}}" class="btn btn-outline-warning shadow-sm"><i class="bi bi-pencil-square"></i> Ganti</a>
                                        <form action="{{url('/delete/' . $bar->idbarang)}}" method="GET" class="d-inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-outline-danger shadow-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"><i class="bi bi-trash2-fill"></i> Hapus</button>
                                        </form>
                                    </td>
                                </tr>
                                @empty
