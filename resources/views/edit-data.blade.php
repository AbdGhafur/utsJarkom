                ...
                <div class="card-body shadow">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br><br>
                            <form action="{{ url('/barang/update/' . $barang->idbarang) }}" method="GET" class="mb-3">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-select" aria-label="kategori...." aria-placeholder="dd" name="kategori">
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-select" aria-label="kategori...." aria-placeholder="dd" name="type">
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="nama_ruang" value="{{ $barang->ruang->nama_ruang }}">
                                    </div>
                                </div>
                                <br>
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" aria-label="With textarea" name="keterangan">{{ $barang->keterangan }}</textarea>
                                    </div>
                                </div>
                                <br>
                                <div class="d-flex gap-2 justify-content-end">
                                    <a class="btn btn-primary shadow-sm" href="{{ route('data') }}" role="button" style="text-decoration: none;" >Batal</a>
